...
//   var x = await fetch(
//     'https://localhost:7280/ControleDeGastos/ObterGastosDiarios?Mes=8&Ano=2025'
//   );
...
//   if (this.window.scrollY > inicialCoords.top) nav.classList.add('sticky');
...
const slider = function () {
  ...
  // slider.style.transform = 'scale(0.9) translateX(-900px)';
