...
them asked 5 dog owners about their dogs age, and
...
the LAST TWO dogs actually have cats, not dogs! 50
...
Kate' s data
3. For each remai ning dog, Iog to the console whether
i t' s an adult ("Dog number I is an adult, and is 5
years old") or a puppy ("Dog number 2 is still a
puppy 🐶")
4. Run the function for both test datasets

HINT: Use tools f rom all lectures in this section so
far 😉
...
const checkDogs = function (arr, arr2) {
  const dogsJuliaCopy = arr.slice(3, 5);
